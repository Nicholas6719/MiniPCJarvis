...
async def lifespan(app: FastAPI):
    ...
    workspace_tools.register_all()   # the folder he gave JARVIS to work in
    model_tools.register_all()    # find a model somebody already made
