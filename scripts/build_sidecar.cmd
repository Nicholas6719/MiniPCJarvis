...
.venv\Scripts\python.exe tests\test_voice_spec.py || (echo VOICE SPEC FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_pocket_tts.py || (echo POCKET TTS FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_protocols.py || (echo PROTOCOLS FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_shortlist_sticky.py || (echo SHORTLIST STICKY FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_math.py || (echo MATH FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_llm_slots.py || (echo LLM SLOTS FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_persona.py || (echo PERSONA FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_detailed.py || (echo DETAILED RENDER FAILED & exit /b 1)
...
.venv\Scripts\python.exe tests\test_phone.py || (echo PHONE TEST FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_icloud.py || (echo ICLOUD TEST FAILED & exit /b 1)
...
.venv\Scripts\python.exe tests\test_background_tasks.py || (echo BACKGROUND TASKS TEST FAILED & exit /b 1)
...
.venv\Scripts\python.exe tests\test_faster.py || (echo FASTER TEST FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_turn_model.py || (echo TURN MODEL TEST FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_awareness.py || (echo AWARENESS TEST FAILED & exit /b 1)
.venv\Scripts\python.exe tests\test_site_find.py || (echo SITE FIND TEST FAILED & exit /b 1)
